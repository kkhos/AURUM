...
::grpc::Status aurumServiceImpl::execute(Command *cmd, bool clean)
{
    ...
    std::unique_ptr<PostCommand> proxyPostCmd =
        std::make_unique<PostCommand>(proxyPreCmd.get());
...
{
    std::unique_ptr<KillServerCommand> cmd =
        std::make_unique<KillServerCommand>(request, response);
...
{
    std::unique_ptr<FindElementCommand> cmd =
        std::make_unique<FindElementCommand>(request, response);
...
{
    std::unique_ptr<FindElementsCommand> cmd =
        std::make_unique<FindElementsCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<ClickCommand> cmd =
        ClickCommand::createCommand(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<GetValueCommand> cmd =
        std::make_unique<GetValueCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<SetValueCommand> cmd =
        std::make_unique<SetValueCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<GetAttributeCommand> cmd =
        GetAttributeCommand::createCommand(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<GetSizeCommand> cmd =
        std::make_unique<GetSizeCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<ClearCommand> cmd =
        std::make_unique<ClearCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<InstallAppCommand> cmd =
        std::make_unique<InstallAppCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<RemoveAppCommand> cmd =
        std::make_unique<RemoveAppCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<GetAppInfoCommand> cmd =
        std::make_unique<GetAppInfoCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<LaunchAppCommand> cmd =
        std::make_unique<LaunchAppCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<CloseAppCommand> cmd =
        std::make_unique<CloseAppCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<TouchDownCommand> cmd =
        std::make_unique<TouchDownCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<TouchUpCommand> cmd =
        std::make_unique<TouchUpCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<TouchMoveCommand> cmd =
        std::make_unique<TouchMoveCommand>(request, response);
    return execute(cmd.get(), false);
}
...
::grpc::Status aurumServiceImpl::longClick(::grpc::ServerContext   *context,
                                           ...
                                           ::aurum::RspClick       *response)
{
    std::unique_ptr<LongClickCommand> cmd =
        std::make_unique<LongClickCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<FlickCommand> cmd =
        std::make_unique<FlickCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<GetDeviceTimeCommand> cmd =
        std::make_unique<GetDeviceTimeCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<GetLocationCommand> cmd =
        std::make_unique<GetLocationCommand>(request, response);
    return execute(cmd.get(), false);
}
...
{
    std::unique_ptr<SendKeyCommand> cmd =
        std::make_unique<SendKeyCommand>(request, response);
    return execute(cmd.get(), false);
}

::grpc::Status aurumServiceImpl::takeScreenshot(
    ::grpc::ServerContext *context, const ::aurum::ReqTakeScreenshot *request,
    ::grpc::ServerWriter< ::aurum::RspTakeScreenshot> *writer)
{
    std::unique_ptr<TakeScreenshotCommand> cmd =
        std::make_unique<TakeScreenshotCommand>(request, writer);
    return execute(cmd.get(), false);
}

::grpc::Status aurumServiceImpl::dumpObjectTree(
    ::grpc::ServerContext *context, const ::aurum::ReqDumpObjectTree *request,
    ::aurum::RspDumpObjectTree *response)
{
    std::unique_ptr<DumpObjectTreeCommand> cmd =
        std::make_unique<DumpObjectTreeCommand>(request, response);
    return execute(cmd.get(), true);
}

::grpc::Status aurumServiceImpl::getScreenSize(
    ::grpc::ServerContext *context, const ::aurum::ReqGetScreenSize *request,
    ::aurum::RspGetScreenSize *response)
{
    std::unique_ptr<GetScreenSizeCommand> cmd =
        std::make_unique<GetScreenSizeCommand>(request, response);
    return execute(cmd.get(), true);
}

::grpc::Status aurumServiceImpl::actionAndWaitEvent(
    ::grpc::ServerContext                *context,
    const ::aurum::ReqActionAndWaitEvent *request,
    ::aurum::RspActionAndWaitEvent       *response)
{
    std::unique_ptr<ActionAndWaitEventCommand> cmd =
        std::make_unique<ActionAndWaitEventCommand>(request, response);
    return execute(cmd.get(), true);
}
...
{
    std::unique_ptr<SetFocusCommand> cmd =
        std::make_unique<SetFocusCommand>(request, response);
    return execute(cmd.get(), true);
}

::grpc::Status aurumServiceImpl::getTextMinBoundingRect(
    ::grpc::ServerContext                    *context,
    const ::aurum::ReqGetTextMinBoundingRect *request,
    ::aurum::RspGetTextMinBoundingRect       *response)
{
    std::unique_ptr<GetTextMinBoundingRectCommand> cmd =
        std::make_unique<GetTextMinBoundingRectCommand>(request, response);
    return execute(cmd.get(), true);
}
