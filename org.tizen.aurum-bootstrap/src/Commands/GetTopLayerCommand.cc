...
#include "GetTopLayerCommand.h"
#include "UiObject.h"

GetTopLayerCommand::GetTopLayerCommand(const ::aurum::ReqGetTopLayer *request,
                               ::aurum::RspGetTopLayer *response)
    : mRequest{request}, mResponse{response}
{
}

::grpc::Status GetTopLayerCommand::execute()
{
    LOGI("GetTopLayer --------------- ");
