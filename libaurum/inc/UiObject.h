...
public:
    /**
     * @brief UiObject constructor with device, selector, nodeptr.
     *
     * @since_tizen 5.5
     */
...
public:
    ...
    /**
     * @brief Gets object's enabled property.
     *
     ...
     *
     * @param durationMs total time to maintain down action (default = 500ms)
     *
     * @since_tizen 5.5
     */
