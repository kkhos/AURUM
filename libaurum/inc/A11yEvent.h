...
enum class A11yEvent {
     ...
     EVENT_WINDOW_RENDER_POST = 0x00500,
...
public:
    ...
    /**
     * @brief A11yEventInfo constructor with event as enum value, name, package.
     *
    ...
    /**
     * @brief A11yEventInfo constructor with event as string value, name, package.
     *
