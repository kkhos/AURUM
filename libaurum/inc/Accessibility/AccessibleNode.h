...
public:
    ...
    /**
     * @brief Notify object related event.
     *
     * @param type @EventType
     * @param type2 @EventType
     * @param src Atspi Node ptr
     *
     * @since_tizen 5.5
     */
...
public:
     ...
     *
     * @param thisIface @AccessibleNodeInterface
     *
     ...
     *
     * @param prop @NodeFeatureProperties
     *
     ...
     *
     * @param prop @NodeFeatureProperties
     * @param has Node has given property ot not
     *
     * @since_tizen 5.5
     */
