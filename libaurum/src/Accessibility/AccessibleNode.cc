...
AccessibleNode::AccessibleNode()
: mText{""}, mOcrText{""}, mPkg{""}, mRole{""}, mId{""}, mAutomationId{""}, mType{""}, mStyle{""}, mXPath{""}, mToolkitName{""}, mInterface{""}, mDescription{""}, mImgSrc{""}, mValueText{""},
...
std::string AccessibleNode::getValueText() const
{
    return mValueText;
}